    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Welcome Section */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-text mb-2">Welcome back, {designer?.name}</h1>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent rounded-xl shadow-lg text-sm font-medium text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-200 hover:scale-105"
            >
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent rounded-xl shadow-lg text-sm font-medium text-white bg-secondary hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary transition-all duration-200 hover:scale-105"
            >
                ...
                <form className="space-y-6" onSubmit={handleCreateNewDesign}>
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        id="design-name"
                        required
                        className="block w-full rounded-xl border-light shadow-sm focus:border-primary focus:ring-primary sm:text-sm transition-colors duration-200"
                  ...
                  <div className="flex justify-end space-x-3">
                    <button
                      ...
                      className="px-4 py-2 border border-light rounded-xl text-sm font-medium text-text bg-white hover:bg-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-200"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="px-4 py-2 border border-transparent rounded-xl text-sm font-medium text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-200"
                    >
                      Create Design
                    </button>
                  </div>
                          ...
                          <div className="bg-light/30 rounded-xl p-4 hover:bg-light/50 transition-all duration-200 border border-light/50">
                            <div className="flex items-center justify-between">
                              ...
                              <button
                                ...
                                className="inline-flex items-center px-3 py-1.5 border border-light rounded-xl text-xs font-medium text-text bg-white hover:bg-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-200 hover:scale-105"
                              >
            ...
            <div className="lg:col-span-2">
              <div className="bg-white shadow-2xl rounded-2xl overflow-hidden border border-light/50 hover:shadow-primary/5 transition-shadow duration-300">
                <div className="px-8 py-6 border-b border-light/50 bg-light/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <FolderPlus className="h-5 w-5 text-secondary mr-2" />
